...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--src_language', required=False, default='英文',type=str, help='PDF file src_language.')
        self.parser.add_argument('--target_language', required=False, default='中文',type=str, help='target_language to translate.')
