...
def launch_gradio():
    ...
    iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Dropdown(label="选择翻译风格", value='Novel Style',choices=["Novel Style", "News Article Style", "Authorial style","Classical poetry style","Nursery rhyme style","Classical Chinese style"])
        ],
        outputs=[
